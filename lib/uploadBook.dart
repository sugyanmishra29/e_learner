...
class UploadState extends State<UploadScreen> {
  ...
  upload(fileName, filePath, String v) {
    _pickType = (v=='1')? (FileType.ANY) : (FileType.IMAGE);
    _extension = fileName.toString().split('.').last;
    StorageReference storageRef = FirebaseStorage.instance.ref().child("Books").child(_category).child(_entered+"."+_extension);
            ...
            children: <Widget>[
              ...
              Row(children: <Widget>[
                  OutlineButton(
                    ...
                    child: new Text("Select PDF"),
                  ),
                OutlineButton(
                  onPressed: _isButtonDisabled ? null : () => openFileExplorer('2'),
                  child: new Text("Select cover image"),
                ),
                ],
              ),
